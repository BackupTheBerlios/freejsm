 ...
 * @author  nahuel
 */
public class JEPPanel extends javax.swing.JPanel {
    ...
    public JEPPanel(Connection extConnection, int st_id, Utilisateur util, PrincipaleGUI papa) {
        this.st_id = st_id;
        this.papa = papa;
        this.util = util;
        ...
        initComponents();
            ...
            ecartTable.getColumnModel().getColumn(0).setMaxWidth(0);
            ecartTable.getColumnModel().getColumn(0).setMinWidth(0);
            ecartTable.getColumnModel().getColumn(0).setPreferredWidth(0);
        ...
        initCommandeClick();
        codeArticleField.setEditable(false);
        designArticleField.setEditable(false);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        codeArticleLabel = new javax.swing.JLabel();
        codeArticleField = new javax.swing.JTextField();
        designArticleLabel = new javax.swing.JLabel();
        designArticleField = new javax.swing.JTextField();
        qtArticleLabel = new javax.swing.JLabel();
        qtArticleField = new javax.swing.JTextField();
        addButton = new javax.swing.JButton();
        delButton = new javax.swing.JButton();
        selectedPane = new javax.swing.JPanel();
        tabScrollPane1 = new javax.swing.JScrollPane();
        ecartTable = new javax.swing.JTable();
        ...
        codeArticleLabel.setText("Code :");
        selectPane.add(codeArticleLabel);

        codeArticleField.setColumns(7);
        codeArticleField.setName("AR_CODE");
        selectPane.add(codeArticleField);

        designArticleLabel.setText("D\u00e9signation :");
        selectPane.add(designArticleLabel);

        designArticleField.setColumns(12);
        designArticleField.setName("AR_DESIGN");
        designArticleField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                designArticleFieldActionPerformed(evt);
            }
        });

        selectPane.add(designArticleField);

        qtArticleLabel.setText("Quantit\u00e9 :");
        selectPane.add(qtArticleLabel);

        qtArticleField.setColumns(3);
        selectPane.add(qtArticleField);
        ...
        ecartTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "", "Code", "Désignation", "Quantité", "Unité de mesure", "TVA", "Prix HT"
            }
        ) {
        ...
        tabScrollPane1.setViewportView(ecartTable);
    ...
    private void delButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delButtonActionPerformed
        DefaultTableModel model = (DefaultTableModel)ecartTable.getModel();
        model.removeRow(ecartTable.getSelectedRow());
    ...
    private void validButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validButtonActionPerformed
        try{
            ...
            for(int i = 0;i<ecartTable.getRowCount();i++){
                ResultSet rset = intConnection.prepareStatement("SELECT CS_QT, CS_PRIXUNITAIRE FROM CONTENU_STOCK WHERE AR_ID = " + ecartTable.getModel().getValueAt(i,0)).executeQuery();
                rset.next();
                
                // Si les stocks actuels sont inférieurs a la valeur rentrée
                if(new java.math.BigDecimal(rset.getFloat("CS_QT")).compareTo(new java.math.BigDecimal(ecartTable.getModel().getValueAt(i,3).toString())) == -1){
                    
                    PreparedStatement statement1 = intConnection.prepareStatement("INSERT INTO JEP (ST_ID, JEP_QT, AR_ID, JEP_PRIXUNITAIRE, JEP_DATE) VALUES("+ st_id + ",'" + (new java.math.BigDecimal(ecartTable.getModel().getValueAt(i,3).toString())).add(new java.math.BigDecimal(rset.getFloat("CS_QT")).negate()) + "',?,'" + rset.getFloat("CS_PRIXUNITAIRE") + "',?)");
                    statement1.setString(1,((Integer)ecartTable.getModel().getValueAt(i,0)).toString());
                    statement1.setString(2,dateFormat.format(new java.util.Date()));
                    statement1.executeUpdate();
                    
                    ResultSet rset2 = intConnection.prepareStatement("select @@IDENTITY as 'ident'").executeQuery();
                    rset2.next();
                    PreparedStatement statement2 = intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID,JO_TABNOM,JO_PRECVAL,JO_NOUVAL,JO_OPERATION) VALUES('"+util.getID() + "','JEP','','###JEP_ID=>" + rset.getInt(1) + "###ST_ID=>" + st_id + "###JEP_QT=>" + (new java.math.BigDecimal(ecartTable.getModel().getValueAt(i,3).toString())).add(new java.math.BigDecimal(rset.getFloat("CS_QT")).negate()) + "###AR_ID=>" + ecartTable.getModel().getValueAt(i,0) + "###JEP_PRIXUNITAIRE=>" + rset.getFloat("CS_PRIXUNITAIRE") + "###JEP_DATE=>" + dateFormat.format(new java.util.Date()) + "','I')");
                    
                    statement2.executeUpdate();
                    
                    intConnection.prepareStatement("UPDATE CONTENU_STOCK SET CS_QT = '" + ecartTable.getModel().getValueAt(i,3) + "' WHERE ST_ID = " + st_id + " AND AR_ID = " + ecartTable.getModel().getValueAt(i,0) ).executeUpdate();
                    
                    // Si les stocks actuels sont supérieurs a la valeur rentrée
                }else if(new java.math.BigDecimal(rset.getFloat("CS_QT")).compareTo(new java.math.BigDecimal(ecartTable.getModel().getValueAt(i,3).toString())) == 1){
                    intConnection.prepareStatement("INSERT INTO JEN (ST_ID, JEN_QT, AR_ID, JEN_PRIXUNITAIRE, JEN_DATE) VALUES(" + st_id + ",'" + (new java.math.BigDecimal(rset.getFloat("CS_QT")).add(new java.math.BigDecimal(ecartTable.getModel().getValueAt(i,3).toString()).negate())) + "','" + ecartTable.getModel().getValueAt(i,0) + "','" + rset.getFloat("CS_PRIXUNITAIRE") + "','" + dateFormat.format(new java.util.Date()) + "')").executeUpdate();
                    ResultSet rset2 = intConnection.prepareStatement("select @@IDENTITY as 'ident'").executeQuery();
                    rset2.next();
                    intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID,JO_TABNOM,JO_PRECVAL,JO_NOUVAL,JO_OPERATION) VALUES('"+util.getID() + "','JEN','','###JEN_ID=>" + rset.getInt(1) + "###ST_ID=>" + st_id + "###JEN_QT=>" + (new java.math.BigDecimal(rset.getFloat("CS_QT")).add(new java.math.BigDecimal(ecartTable.getModel().getValueAt(i,3).toString()).negate())) + "###AR_ID=>" + ecartTable.getModel().getValueAt(i,0) + "###JEN_PRIXUNITAIRE=>" + rset.getFloat("CS_PRIXUNITAIRE") + "###JEN_DATE=>" + dateFormat.format(new java.util.Date()) + "','I')").executeUpdate();
            ...
            JOptionPane.showMessageDialog(this,"La saisie des stocks à bien été effectuée","Saisie effectué",JOptionPane.INFORMATION_MESSAGE,null);
            etatDeBase();
        }catch(Exception e){
            System.out.println("[JEPPanel][validButtonActionPerformed] Exception : " +e );
            e.printStackTrace();
        }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
            ...
            try{
                if(!enModification){
                    ...
                    arData.add(qtArticleField.getText());
                    arData.add(new Float(rset.getFloat("AR_COND")));
                    arData.add(rset.getString("AR_UNIT"));
                    arData.add((new Float(rset.getFloat("CS_PRIXUNITAIRE") * (new Float(qtArticleField.getText())).floatValue())).toString());

                    model.addRow(arData);

                    ecartTable.setModel(model);
                }else{
                    ResultSet rset = intConnection.prepareStatement("SELECT CS_PRIXUNITAIRE FROM CONTENU_STOCK WHERE AR_ID = " + ecartTable.getModel().getValueAt(ecartTable.getSelectedRow(), 0)).executeQuery();
                    rset.next();
                    ecartTable.setValueAt(qtArticleField.getText(), ecartTable.getSelectedRow(), 3);
                    ecartTable.setValueAt(new Integer(new Integer(qtArticleField.getText()).intValue() * rset.getInt("CS_PRIXUNITAIRE")), ecartTable.getSelectedRow(), 6);
                    etatDeBase();
                ...
                System.out.println("[JEPPanel][addButtonActionPerformed] Exception : " +e);
                e.printStackTrace();
            }
    ...
    private void designArticleFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_designArticleFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_designArticleFieldActionPerformed
    ...
    private javax.swing.JLabel codeArticleLabel;
    private javax.swing.JTextField codeField;
    private javax.swing.JLabel codeLabel;
    private javax.swing.JPanel commandPane;
    private javax.swing.JButton delButton;
    private javax.swing.JTextField designArticleField;
    private javax.swing.JLabel designArticleLabel;
    private javax.swing.JTextField designField;
    private javax.swing.JLabel designLabel;
    private javax.swing.JTable ecartTable;
    ...
    private javax.swing.JTextField qtArticleField;
    private javax.swing.JLabel qtArticleLabel;
    ...
    private void initCommandeClick() {
       ecartTable.addMouseListener(new MouseAdapter(){
          public void mouseClicked(MouseEvent e){
            if ((e.getClickCount() == 2) && ( checkAnnulation())){
              try{
                    ...
                    qtEnModif = ((Integer)ecartTable.getModel().getValueAt(ecartTable.getSelectedRow(), 0)).intValue();
                    qtArticleField.setText((String)ecartTable.getModel().getValueAt(ecartTable.getSelectedRow(), 3));
                    codeArticleField.setText((String)ecartTable.getModel().getValueAt(ecartTable.getSelectedRow(), 1));
                    designArticleField.setText((String)ecartTable.getModel().getValueAt(ecartTable.getSelectedRow(), 2));
    ...
    public void refresh(){
     try{
        if(selectedCAID.intValue() != 0){
         ...
         System.out.println("[JEPPanel][refresh] Exception : " + e);
         e.printStackTrace();
     }
    }
    ...
    private String getCAT(Integer parent){
        String retour = new String(parent.toString());
            try{
                ...
                System.out.println("[JEPPanel][getCAT] Exception : " + e );
                e.printStackTrace();
            }
        return retour;
    }    
    ...
    private void etatDeBase(){
        qtArticleField.setText("");
        codeArticleField.setText("");
        designArticleField.setText("");
    }   
