 ...
 * @author  nahuel
 */
public class JENPanel extends javax.swing.JPanel {
    ...
    public JENPanel(Connection extConnection, int st_id, Utilisateur util, PrincipaleGUI papa) {
        this.st_id = st_id;
        this.papa = papa;
        this.util = util;
    ...
    private void validButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validButtonActionPerformed
        try{
            ...
            for(int i = 0;i<ecartTable.getRowCount();i++){
                ResultSet rset = intConnection.prepareStatement("SELECT CS_PRIXUNITAIRE FROM CONTENU_STOCK WHERE AR_ID = " + ecartTable.getModel().getValueAt(i,0)).executeQuery();
                rset.next();
                PreparedStatement statement1 = intConnection.prepareStatement("INSERT INTO JEN (JEN_QT, AR_ID, JEN_PRIXUNITAIRE, JEN_DATE) VALUES(?,?,?,?)");
                //"'" + ecartTable.getModel().getValueAt(i,3) + "'," + ecartTable.getModel().getValueAt(i,0) + "," + rset.getFloat("CS_PRIXUNITAIRE") + "," + dateFormat.format(new java.util.Date()));
                statement1.setString(1,(String)ecartTable.getModel().getValueAt(i,3));
                statement1.setString(2,(String)ecartTable.getModel().getValueAt(i,0));
                statement1.setFloat(3,rset.getFloat("CS_PRIXUNITAIRE"));
                statement1.setString(4,dateFormat.format(new java.util.Date()));
                statement1.executeUpdate();
                
                ResultSet rset2 = intConnection.prepareStatement("select @@IDENTITY as 'ident'").executeQuery();
                rset2.next();
                
                PreparedStatement statement2 = intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID,JO_TABNOM,JO_PRECVAL,JO_NOUVAL,JO_OPERATION) VALUES("+util.getID() + ",'JEN','','###JEN_ID=>" + rset.getInt(1) + "###JEN_QT=>?###AR_ID=>?###JEN_PRIXUNITAIRE=>?###JEN_DATE=>?");
                //###JEN_ID=>" + rset.getInt(1) + "###JEN_QT=>" + ecartTable.getModel().getValueAt(i,3) + "###AR_ID=>" + ecartTable.getModel().getValueAt(i,0) + "###JEN_PRIXUNITAIRE=>" + rset.getFloat("CS_PRIXUNITAIRE") + "###JEN_DATE=>" + dateFormat.format(new java.util.Date()));
                statement2.setString(1,(String)ecartTable.getModel().getValueAt(i,3));
                statement2.setString(2,(String)ecartTable.getModel().getValueAt(i,0));
                statement2.setFloat(3,rset.getFloat("CS_PRIXUNITAIRE"));
                statement2.setString(4,dateFormat.format(new java.util.Date()));
            ...
            System.out.println("[JENPanel][validButtonActionPerformed] Exception : " +e );
            e.printStackTrace();
        }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
            ...
            try{
                ...
                System.out.println("[JENPanel][addButtonActionPerformed] Exception : " +e);
                e.printStackTrace();
            }
    ...
    public void refresh(){
     try{
        if(selectedCAID.intValue() != 0){
         ...
         System.out.println("[JENPanel][refresh] Exception : " + e);
         e.printStackTrace();
     }
    }
    ...
    private String getCAT(Integer parent){
        String retour = new String(parent.toString());
            try{
                ...
                System.out.println("[JENPanel][getCAT] Exception : " + e );
                e.printStackTrace();
            }
        return retour;
    }    
