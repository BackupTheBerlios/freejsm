 ...
 * @author  nahuel
 */
public class PaneEntree extends javax.swing.JPanel {
    ...
    public PaneEntree(Connection extConnection, int st_id, Utilisateur util, forms.PrincipaleGUI papa) {
        this.st_id = st_id;
        this.papa = papa;
        this.util = util;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/develog/icones/import.png")));
        ...
        commandeTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class
            };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        (new dialogs.ImportCommande(papa, true, intConnection, st_id, this)).show();
    ...
    private void validButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validButtonActionPerformed
        try{
                if(commandeTable.getRowCount()>0){
                    ...
                    intConnection.prepareStatement("INSERT INTO ENTREE (UTIL_ID,ST_ID,ENT_DATE) VALUES(" + util.getID() + "," + st_id + ",'" + dateFormat.format(new java.util.Date()) + "')").executeUpdate();

                    ResultSet rset = intConnection.prepareStatement("select @@IDENTITY as 'ident'").executeQuery();
                    rset.next();

                    intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID,JO_TABNOM,JO_PRECVAL,JO_NOUVAL,JO_OPERATION) VALUES(" + util.getID() + ",'ENTREE','','###ENT_ID=>" + rset.getInt(1) + "###UTIL_ID=>" +  util.getID() + "###ST_ID=>" + st_id + "###ENT_DATE=>"+ dateFormat.format(new java.util.Date()) + "','I')").executeUpdate();
                    
                    for(int i = 0 ; i < commandeTable.getRowCount() ; i++){
                        if( ((Float)commandeTable.getModel().getValueAt(i,3)).floatValue() != 0){
                            ResultSet rset4 = intConnection.prepareStatement("SELECT * FROM CONTENU_STOCK WHERE AR_ID = " + commandeTable.getModel().getValueAt(i,0) + " AND ST_ID = " + st_id).executeQuery();
                            rset4.next();

                            intConnection.prepareStatement("INSERT INTO CONTENU_ENTREE (ENT_ID, AR_ID, CE_QT, AR_PRIX) VALUES(" + rset.getInt(1) + "," + commandeTable.getModel().getValueAt(i,0) + "," + (new java.math.BigDecimal(commandeTable.getModel().getValueAt(i,3).toString())).multiply(new java.math.BigDecimal(commandeTable.getModel().getValueAt(i,4).toString())) + ",'" + commandeTable.getModel().getValueAt(i,7) + "')").executeUpdate();
                            ResultSet rset2 = intConnection.prepareStatement("select @@IDENTITY as 'ident'").executeQuery();
                            rset2.next();
                            intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID,JO_TABNOM,JO_PRECVAL,JO_NOUVAL,JO_OPERATION) VALUES(" + util.getID() + ",'CONTENU_ENTREE','','###CE_ID=>" + rset2.getInt(1) + "###ENT_ID=>" + rset.getInt(1) + "###AR_ID=>" + commandeTable.getModel().getValueAt(i,0) + "###CE_QT=>" + (new java.math.BigDecimal(commandeTable.getModel().getValueAt(i,3).toString())).multiply(new java.math.BigDecimal(commandeTable.getModel().getValueAt(i,4).toString())) +"###AR_PRIX=>" + commandeTable.getModel().getValueAt(i,7) +"','I')" ).executeUpdate();


                             ResultSet rset3 = intConnection.prepareStatement("SELECT CS_QT, CS_ID FROM CONTENU_STOCK WHERE ST_ID = " + st_id + " AND AR_ID = " + commandeTable.getModel().getValueAt(i,0)).executeQuery();
                             rset3.next();
                             intConnection.prepareStatement("UPDATE CONTENU_STOCK SET CS_QT = " + rset3.getBigDecimal("CS_QT").add((new java.math.BigDecimal(commandeTable.getModel().getValueAt(i,3).toString())).multiply(new java.math.BigDecimal(commandeTable.getModel().getValueAt(i,4).toString()))).divide(new java.math.BigDecimal(1),2,java.math.BigDecimal.ROUND_HALF_UP) + " WHERE CS_ID = " + rset3.getInt("CS_ID")).executeUpdate();

                             intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID, JO_TABNOM, JO_PRECVAL, JO_NOUVAL, JO_OPERATION) VALUES(" + util.getID() + ",'CONTENU_STOCK'," + "'###CS_ID=>" + rset4.getString("CS_ID") + "###ST_ID=>" + rset4.getString("ST_ID") + "###AR_ID=>" + rset4.getString("AR_ID") + "###CS_QT=>" + rset4.getBigDecimal("CS_QT").divide(new java.math.BigDecimal(1),2,java.math.BigDecimal.ROUND_HALF_UP) + "###CS_SEUIL=>" + rset4.getString("CS_SEUIL") + "###CS_EC=>0###CS_PRIXUNITAIRE=>" + rset4.getString("CS_PRIXUNITAIRE") + "','###CS_ID=>" + rset4.getString("CS_ID") + "###ST_ID=>" + st_id + "###AR_ID=>" + commandeTable.getModel().getValueAt(i,0) + "###CS_QT=>" + (rset3.getBigDecimal("CS_QT")).add((new java.math.BigDecimal(commandeTable.getModel().getValueAt(i,3).toString())).multiply(new java.math.BigDecimal(commandeTable.getModel().getValueAt(i,4).toString()))).divide(new java.math.BigDecimal(1),2,java.math.BigDecimal.ROUND_HALF_UP) + "###CS_SEUIL=>" + rset4.getString("CS_SEUIL") + "###CS_EC=>0###CS_PRIXUNITAIRE=>" + rset4.getString("CS_PRIXUNITAIRE") + "','U')").executeUpdate();
                        }
                    }
                    JOptionPane.showMessageDialog(this,"Le bon d'entrée a bien été ajouté","Ajout effectué",JOptionPane.INFORMATION_MESSAGE,null);
            ...
            System.out.println("[PaneEntree][validButtonActionPerformed] Exception : " +e );
            e.printStackTrace();
        }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
            ...
            try{
                if(!enModification){
                    ...
                    ResultSet rset = intConnection.prepareStatement("SELECT AR_CODE, AR_DESIGN, AR_UNIT, AR_COND, TVA_TX, CS_PRIXUNITAIRE FROM TVA, ARTICLE, CONTENU_STOCK WHERE ARTICLE.TVA_ID = TVA.TVA_ID AND CONTENU_STOCK.AR_ID = ARTICLE.AR_ID AND ARTICLE.AR_ID = " + productintsc.getCubeInt("AR_ID") ).executeQuery();
                    rset.next();

                    arData.add(productintsc.getCubeInt("AR_ID"));
                    arData.add(rset.getString("AR_CODE"));
                    arData.add(rset.getString("AR_DESIGN"));
                    arData.add(new Float(qtCommandeField.getText()));
                    arData.add(rset.getString("AR_COND"));
                    arData.add(rset.getString("AR_UNIT"));
                    arData.add(rset.getString("TVA_TX"));
                    arData.add(new Float(rset.getFloat("CS_PRIXUNITAIRE") * new Float(qtCommandeField.getText()).floatValue()));
                    model.addRow(arData);
                ...
                System.out.println("[PaneEntree][addButtonActionPerformed] Exception : " +e);
                e.printStackTrace();
            }
    ...
    public void refresh(){
     try{
        if(selectedCAID.intValue() != 0){
         ...
         System.out.println("[PaneEntree][refresh] Exception : " + e);
         e.printStackTrace();
     }
    }
    ...
    private String getCAT(Integer parent){
        String retour = new String(parent.toString());
            try{
                ...
                System.out.println("[PaneEntree][getCAT] Exception : " + e );
                e.printStackTrace();
            }
        return retour;
    }    
    ...
    public void importCommande(Integer co_id){
        try{
            ResultSet rset = intConnection.prepareStatement("SELECT ARTICLE.AR_ID, AR_CODE, AR_DESIGN, AR_COND, CC_QT, AR_UNIT, TVA.TVA_TX, AR_PRIX  FROM ARTICLE, CONTENU_COMMANDE, TVA WHERE ARTICLE.AR_ID = CONTENU_COMMANDE.AR_ID AND TVA.TVA_ID = ARTICLE.TVA_ID AND CO_ID = " + co_id).executeQuery();
            while(rset.next()){
                Vector arData = new Vector();
                DefaultTableModel model = (DefaultTableModel)commandeTable.getModel();
                arData.add(new Integer(rset.getInt("AR_ID")));
                arData.add(rset.getString("AR_CODE"));
                arData.add(rset.getString("AR_DESIGN"));
                arData.add(new Float(rset.getString("CC_QT")));
                arData.add(rset.getString("AR_COND"));
                arData.add(rset.getString("AR_UNIT"));
                arData.add(rset.getString("TVA_TX"));
                arData.add(new Float(rset.getFloat("AR_PRIX")));
                
                model.addRow(arData);
                commandeTable.setModel(model);
            }
            JOptionPane.showConfirmDialog(this,"La commande a été correctement importée","Import fini",JOptionPane.CLOSED_OPTION,JOptionPane.INFORMATION_MESSAGE,null);
        }catch(Exception e){
            System.out.println("[PaneEntree][importCommande] Exception : "+ e);
            e.printStackTrace();
        }
    }
