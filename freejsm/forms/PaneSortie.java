 ...
 * @author  nahuel
 */
public class PaneSortie extends javax.swing.JPanel {
    ...
    /** Creates new form PaneSortie */
    public PaneSortie(Connection extConnection, int st_id, Utilisateur util, forms.PrincipaleGUI papa) {
        this.st_id = st_id;
        this.papa = papa;
        this.util = util;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        majButton.setMaximumSize(new java.awt.Dimension(50, 26));
        majButton.setMinimumSize(new java.awt.Dimension(50, 26));
        majButton.setPreferredSize(new java.awt.Dimension(50, 26));
        ...
        commandeTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class
            };
    ...
    private void validButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validButtonActionPerformed
        try{
            if(commandeTable.getRowCount()>0){
                ...
                intConnection.prepareStatement("INSERT INTO SORTIE (UTIL_ID,ST_ID,SORT_DATE) VALUES(" + util.getID() + "," + st_id + ",'" + dateFormat.format(new java.util.Date()) + "')").executeUpdate();

                ResultSet rset = intConnection.prepareStatement("select @@IDENTITY as 'ident'").executeQuery();
                rset.next();

                intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID,JO_TABNOM,JO_PRECVAL,JO_NOUVAL,JO_OPERATION) VALUES(" + util.getID() + ",'SORTIE','','###SORT_ID=>" + rset.getInt(1) + "###UTIL_ID=>" +  util.getID() + "###ST_ID=>" + st_id + "###SORT_DATE=>"+ dateFormat.format(new java.util.Date()) + "','I')").executeUpdate();

                for(int i = 0 ; i < commandeTable.getRowCount() ; i++){
                    
                    if( ((Float)commandeTable.getModel().getValueAt(i,3)).floatValue() != 0){
                        ResultSet rset4 = intConnection.prepareStatement("SELECT * FROM CONTENU_STOCK WHERE AR_ID = " + commandeTable.getModel().getValueAt(i,0)).executeQuery();
                        rset4.next();

                        System.out.println("row : " + i);
                        intConnection.prepareStatement("INSERT INTO CONTENU_SORTIE (SORT_ID, AR_ID, CS_QT, AR_PRIX) VALUES(" + rset.getInt(1) + "," + commandeTable.getModel().getValueAt(i,0) + "," + commandeTable.getModel().getValueAt(i,3) + ",'" + commandeTable.getModel().getValueAt(i,6) + "')").executeUpdate();
                        ResultSet rset2 = intConnection.prepareStatement("select @@IDENTITY as 'ident'").executeQuery();
                        rset2.next();
                        intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID,JO_TABNOM,JO_PRECVAL,JO_NOUVAL,JO_OPERATION) VALUES(" + util.getID() + ",'CONTENU_SORTIE','','###CS_ID=>" + rset2.getInt(1) + "###SORT_ID=>" + rset.getInt(1) + "###AR_ID=>" + commandeTable.getModel().getValueAt(i,0) + "###CS_QT=>" + commandeTable.getModel().getValueAt(i,3) +"###AR_PRIX=>" + commandeTable.getModel().getValueAt(i,6) +"','I')" ).executeUpdate();
                         ...
                         rset3.next();
                         intConnection.prepareStatement("UPDATE CONTENU_STOCK SET CS_QT = " + (rset3.getFloat("CS_QT") - ((Float)commandeTable.getModel().getValueAt(i,3)).floatValue()) + " WHERE CS_ID = " + rset3.getInt("CS_ID")).executeUpdate();

                         //System.out.println("INSERT INTO JOURNAL (UTIL_ID, JO_TABNOM, JO_PRECVAL, JO_NOUVAL, JO_OPERATION) VALUES(" + util.getID() + ",'CONTENU_STOCK'," + "'###CS_ID=>" + rset4.getString("CS_ID") + "###ST_ID=>" + rset4.getString("ST_ID") + "###AR_ID=>" + rset4.getString("AR_ID") + "###CS_QT=>" + rset4.getString("CS_QT") + "###CS_SEUIL=>" + rset4.getString("CS_SEUIL") + "###CS_EC=>0###CS_PRIXUNITAIRE=>" + rset4.getString("CS_PRIXUNITAIRE") + "','###CS_ID=>" + rset4.getString("CS_ID") + "###ST_ID=>" + st_id + "###AR_ID=>" + commandeTable.getModel().getValueAt(i,0) + "###CS_QT=>" + (rset4.getInt("CS_QT") - (new Integer(commandeTable.getModel().getValueAt(i,3).toString())).intValue()) + "###CS_SEUIL=>" + rset4.getString("CS_SEUIL") + "###CS_EC=>0###CS_PRIXUNITAIRE=>" + rset4.getString("CS_PRIXUNITAIRE") + "','U')");
                         intConnection.prepareStatement("INSERT INTO JOURNAL (UTIL_ID, JO_TABNOM, JO_PRECVAL, JO_NOUVAL, JO_OPERATION) VALUES(" + util.getID() + ",'CONTENU_STOCK'," + "'###CS_ID=>" + rset4.getString("CS_ID") + "###ST_ID=>" + rset4.getString("ST_ID") + "###AR_ID=>" + rset4.getString("AR_ID") + "###CS_QT=>" + rset4.getString("CS_QT") + "###CS_SEUIL=>" + rset4.getString("CS_SEUIL") + "###CS_EC=>0###CS_PRIXUNITAIRE=>" + rset4.getString("CS_PRIXUNITAIRE") + "','###CS_ID=>" + rset4.getString("CS_ID") + "###ST_ID=>" + st_id + "###AR_ID=>" + commandeTable.getModel().getValueAt(i,0) + "###CS_QT=>" + (rset4.getFloat("CS_QT") - (new Float(commandeTable.getModel().getValueAt(i,3).toString())).floatValue()) + "###CS_SEUIL=>" + rset4.getString("CS_SEUIL") + "###CS_EC=>0###CS_PRIXUNITAIRE=>" + rset4.getString("CS_PRIXUNITAIRE") + "','U')").executeUpdate();
                    }
                }
            ...
            System.out.println("[PaneSortie][validButtonActionPerformed] Exception : " +e );
            e.printStackTrace();
        }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
            ...
            try{
                if(!enModification){
                    ...
                    ResultSet rset = intConnection.prepareStatement("SELECT AR_CODE, AR_DESIGN, AR_UNIT, TVA_TX, CS_PRIXUNITAIRE FROM TVA, ARTICLE, CONTENU_STOCK WHERE ARTICLE.TVA_ID = TVA.TVA_ID AND CONTENU_STOCK.AR_ID = ARTICLE.AR_ID AND ARTICLE.AR_ID = " + productintsc.getCubeInt("AR_ID") ).executeQuery();
                    rset.next();
                ...
                System.out.println("[PaneSortie][addButtonActionPerformed] Exception : " +e);
                e.printStackTrace();
            }
    ...
    public void refresh(){
     try{
        if(selectedCAID.intValue() != 0){
         ...
         System.out.println("[PaneSortie][refresh] Exception : " + e);
         e.printStackTrace();
     }
    }
    ...
    private String getCAT(Integer parent){
        String retour = new String(parent.toString());
            try{
                ...
                System.out.println("[PaneSortie][getCAT] Exception : " + e );
                e.printStackTrace();
            }
        return retour;
    }    
