 ...
 * @author  yann
 */
public class PaneProduits extends javax.swing.JPanel {
    ...
    public PaneProduits(Connection extConnex, PrincipaleGUI pGUI, int st_id, int util_id) {
    ...
    private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
		...
		statement1.setString(2,saisieDesignField.getText());
                ...
                intConnection.prepareStatement("UPDATE CONTENU_STOCK SET ST_ID = " + st_id + ", AR_ID = " + producteditintsc.getCubeInt("AR_ID") + ", CS_QT = " + qtField.getText() + ", CS_SEUIL = " + reaproField.getText() + ", CS_EC = 0, CS_PRIXUNITAIRE = " + valueField.getText() + " WHERE AR_ID = " + producteditintsc.getCubeInt("AR_ID") + " AND ST_ID = " + st_id).executeUpdate();
                ...
                rset.next();
                intConnection.prepareStatement("INSERT INTO CONTENU_STOCK (ST_ID, AR_ID, CS_QT, CS_SEUIL, CS_EC, CS_PRIXUNITAIRE) VALUES(" + st_id + "," + rset.getInt("ident") + "," + qtField.getText() + "," + reaproField.getText() + ",0,'" + valueField.getText() + "')").executeUpdate();
            }
